                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="{{url('uploads')}}/{{$pro->image}}"><img class="product__media--preview__items--img" src="{{url('uploads')}}/{{$pro->image}}" alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox" href="{{url('uploads')}}/{{$pro->image}}" data-gallery="product-media-preview">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="{{url('uploads')}}/{{$img->image}}"><img class="product__media--preview__items--img" src="{{url('uploads')}}/{{$img->image}}" alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox" href="{{url('uploads')}}/{{$img->image}}" data-gallery="product-media-preview">
                                                    <svg class="product__media--view__icon--svg" xmlns="http://www.w3.org/2000/svg" width="22.51" height="22.443" viewBox="0 0 512 512"><path d="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"></path><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="32" d="M338.29 338.29L448 448"></path></svg>
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="{{url('uploads')}}/{{$pro->image}}" alt="product-nav-img">
                                        </div>
                                    </div>
                                    @foreach($img_pro as $img)
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="{{url('uploads')}}/{{$img->image}}" alt="product-nav-img">
                                        </div>
                                    </div>
                                    @endforeach
                                </div>
                    ...
                    <div class="col">
                        <div class="product__details--info">
                            <form action="{{route('cart.add')}}" method="POST">
                                @csrf
                                <h2 class="product__details--info__title mb-15">{{$pro->name}}</h2>
                                
                                <div class="product__details--info__price mb-10 gia">
                                    <span class="current__price">{{$pro->proV->min('price')}}$</span>
                                    -
                                    <span class="current__price">{{$pro->proV->max('price')}}$</span>
                                ...
                                <div class="product__variant">
                                    <div class="product__variant--list mb-10">
                                        <fieldset class="variant__input--fieldset">
                                            ...
                                            $arrayPV = [];
                                            @endphp
                                            @foreach($pro->proV as $item)
                                                @php
                                                if(isset($arrayPV[json_decode( $item->id_attr_values)[0]])){
                                                    
                                                } else{
                                                    $arrayPV[json_decode( $item->id_attr_values)[0]] = $item;
                                                }
                                                @endphp
                                            @endforeach
                                            
                                            @foreach($arrayPV as $key=> $item)
                                           
                                                @foreach($item->getAtt() as $at)
                                            
                                                @if($at->attr->type == 3)

                                                    <input id="color-red{{$key}}" name="color_value" type="radio" value="{{$at->value}}">
                                                    <label class="variant__size--value red color" style="background:{{$at->value}}" id="test" for="color-red{{$key}}" product_id="{{$item->product_id}}" id_attr_values="{{$at->id}}"></label>
                                                @endif
                                                @endforeach
                                            @endforeach    
                                        </fieldset>
                                        <input type="text" name="cl" id="">
                                        <input type="text" name="cl_value" id="">
                                        <input type="text" name="size" id="">
                                        <input type="text" name="size_value" id="">
                                        <input type="text" name="id_product" value="{{$pro->id}}">
                                        ...
                                        <fieldset class="variant__input--fieldset weight">
                                            ...
                                            <div class="hung">
                                                @foreach($arrayPV as $key => $item)
                                                    @foreach($item->getAtt() as $at)
                                                    @if($at->attr->type == 1)
                                                <input id="weight{{$key}}" name="weight" type="radio">
                                                <label class="variant__size--value red" for="weight{{$key}}">{{$at->value}}</label>
                                                @endif
                                                    @endforeach
                                                @endforeach
                                            </div>
                                    ...
                                    <div class="product__variant--list quantity d-flex align-items-center mb-20">
                                        <div class="quantity__box">
                                            ...
                                            <label>
                                                <input type="number" name="quantity" class="quantity__number quickview__value--number" value="1" />
                                            </label>
                                ...
                                <div class="guarantee__safe--checkout">
                                    ...
                                    <img class="guarantee__safe--checkout__img" src="{{url('assets')}}/img/other/safe-checkout.png" alt="Payment Image">
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="shipping__section2--inner shipping__style3--inner d-flex justify-content-between">
                    <div class="shipping__items2 d-flex align-items-center">
                        <div class="shipping__items2--icon">
                            <img src="{{url('assets')}}/img/other/shipping1.png" alt="">
                        </div>
                    ...
                    <div class="shipping__items2 d-flex align-items-center">
                        <div class="shipping__items2--icon">
                            <img src="{{url('assets')}}/img/other/shipping2.png" alt="">
                        </div>
                        <div class="shipping__items2--content">
                    ...
                    <div class="shipping__items2 d-flex align-items-center">
                        <div class="shipping__items2--icon">
                            <img src="{{url('assets')}}/img/other/shipping3.png" alt="">
                        </div>
                        <div class="shipping__items2--content">
                    ...
                    <div class="shipping__items2 d-flex align-items-center">
                        <div class="shipping__items2--icon">
                            <img src="{{url('assets')}}/img/other/shipping4.png" alt="">
                        </div>
                        <div class="shipping__items2--content">
...
<script>
                ...
                success:function(data) {
                  var _html = '';
                   ...
                   for (const key of data) {
                       console.log(key[1]);
                       _html += `<input id="weight${key[1].id}" name="size_value" type="radio" value="${key[1].value}">
                                            <label class="variant__size--value red" for="weight${key[1].id}" onclick="getSize(${key[1].id})">${key[1].value}</label>`;
                   }
        ...
        function getSize(id){
            ...
            var idProV =  $('.color').attr('product_id');
            var id_color = $('input[name=cl]').val();
            var id_size = id;
           
            $.ajax({
                type:'POST',
                url:'/getPrice',
                data:{idV:idProV,id_color:id_color,id_size:id_size},
                success:function(data) {
                    $('.gia').html(data.price)
                }
            });
