                                                ...
                                                <td class="cart__table--body__list">
                                                    <div class="cart__product d-flex align-items-center">
                                                        ...
                                                        <div class="cart__thumbnail">
                                                            <a href="product-details.html"><img class="border-radius-5" src="{{url('uploads')}}/{{$data['image']}}" alt="cart-product"></a>
                                                        </div>
                                                        <div class="cart__content">
                                                            <h4 class="cart__content--title"><a href="product-details.html">{{$data['product_name']}}</a></h4>
                                                            <span class="cart__content--variant">COLOR: {{$data['color']}}</span>
                                                            <span class="cart__content--variant">WEIGHT:{{$data['size']}}</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="cart__table--body__list">
                                                    <span class="cart__price">£{{$data['price']}}</span>
                                                </td>
                                                <td class="cart__table--body__list">
